[cooltmlproject-3f10] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [cooltmlproject-3f10] container is NOT running**.

.. tip::
   You must have your [cooltmlproject-3f10] container running before connecting to the Visualization and Airflow URLs.
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=39399  \-\-env VIPERVIZPORT=49689  \-\-env GITUSERNAME='smaurice101'  \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env MQTTUSERNAME='smaurice'  \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:49689/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   maadsdocker/cooltmlproject-3f10-amd64 (https://hub.docker.com/r/maadsdocker/cooltmlproject-3f10-amd64)
...
.. code-block::
   ...
   docker run -d -p 49649:49649 -p 58423:58423 -p 56121:56121 \
          --env TSS=0 \
          --env SOLUTIONNAME=cooltmlproject-3f10 \
          --env SOLUTIONDAG=solution_preprocessing_dag-cooltmlproject-3f10 \
          --env GITUSERNAME=smaurice101  \
          --env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git \
          --env SOLUTIONEXTERNALPORT=49649 \
          -v /var/run/docker.sock:/var/run/docker.sock:z \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=58423 \
          --env SOLUTIONVIPERVIZPORT=56121 \
          ...
          maadsdocker/cooltmlproject-3f10-amd64
...
[cooltmlproject-3f10] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/cooltmlproject-3f10
...
.. important::
   https://cooltmlproject-3f10.readthedocs.io
...
.. important::
   solution_preprocessing_dag-cooltmlproject-3f10
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=49649, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=41883, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=39345, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=45251, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=35001, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=37825, HPDEHOST=127.0.1.1, HPDEPORT=36835, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=33751

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-8037-cooltmlproject-3f10,solution_preprocessing_dag-cooltmlproject-3f10, python-preprocess-4348-cooltmlproject-3f10,solution_preprocessing_dag-cooltmlproject-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
